...
class ModuleArguments:
    ...
    stt: Optional[
        ...
        metadata={
            ...
            "'parakeet-tdt', 'paraformer', or 'elevenlabs-scribe'. Default is 'parakeet-tdt'."
        },
    )
    ...
    tts: Optional[Literal["chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "elevenlabs"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or "
            "'elevenlabs'. Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
